...
//        {
//            Debug.LogError("[Firebase] 이메일/비밀번호가 비어 있음");
//            return;
//        }
...
//                if (task.IsCanceled)
//                {
//                    Debug.LogError("[Firebase] 회원가입 취소");
//                    return;
//                }
//                if (task.IsFaulted)
//                {
...
//                Debug.Log("[Firebase] 회원가입 성공: " + newUser.UserId);
//            });
//    }
...
//        if (!firebaseReady)
//        {
//            Debug.LogError("[Firebase] 아직 초기화 전");
//            yield break;
//        }
...
//                if (task.IsCanceled)
//                {
//                    Debug.LogError("[Firebase] 구글 자격증명 로그인 취소");
//                    return;
//                }
//                if (task.IsFaulted)
//                {
//                    Debug.LogError("[Firebase] 구글 자격증명 로그인 실패: " + task.Exception);
//                    return;
//                }

//                user = task.Result;
//                Debug.Log("[Firebase] 구글 자격증명 로그인 성공: " + user.UserId);
//            });
//    }
//}
